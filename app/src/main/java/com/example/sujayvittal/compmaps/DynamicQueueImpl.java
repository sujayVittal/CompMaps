...
/**
 * Created by sujayvittal on 12/01/15.
 */
public class DynamicQueueImpl {
   ...
   public void enqueue(int item){
       ...
       if(isQueueFull()){
           System.out.println("Direction queue is full. Increase the capacity!\n");
           increaseCapacity();
       }
       rear++;
    ...
    public void dequeue() {
        if (isQueueEmpty()) {
            System.out.println("Underflow ! Unable to remove route from the directory of directions!\n");
        } else {
            front++;
